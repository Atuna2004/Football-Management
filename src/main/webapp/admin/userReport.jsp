...
<html>
    ...
    <div class="reports-container" id="reportsContainer">
        <c:forEach var="report" items="${reportList}">
            <div class="report-card" data-status="${report.status}" data-search="${fn:toLowerCase(report.title)}">
                ...
                <div class="report-header">
                    ...
                    <div class="user-info">
                        <h4>Người dùng #${report.userID}</h4>
                        <p>Email: N/A</p>
                    </div>
                </div>
                ...
                <div class="report-details">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value">
                            <!-- Nếu không có type thì để mặc định -->
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value">
                            <!-- Nếu không có priority thì không hiển thị -->
                            Không có thông tin
                        </span>
                    </div>
                    <div class="detail-row">
                ...
                <!-- File đính kèm: tạm thời không hỗ trợ nếu chưa có attachments -->
